        ...
        service.channels.list({
            ...
            if (channels.length == 0) {
                ...
                console.log('This channel\'s ID is %s. Its title is \'%s\', and ' +
                    'it has %s subscribers.',
                    channels[0].id,
                    channels[0].snippet.title,
                    channels[0].statistics.subscriberCount);
                outputCallback(channels[0].statistics.subscriberCount);
            }
        });
    }
}
...
export const asyncGetSubs = async (channel) => {
    return new Promise((res, rej) => {
        getSubscriberCount("UCQt_y4kqMQlG1id0n975DVg", (subscribers) => {
            res(subscribers);
        });
